...
public:
    ...
    stl_allocator() : allocator_(Allocator::instance()) {}
    stl_allocator(const stl_allocator&) : allocator_(Allocator::instance()) {}
    ...
    void construct(pointer ptr, const T& val) { ::new (static_cast<void*>(ptr)) T(val); };
