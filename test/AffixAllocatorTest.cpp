...
TYPED_TEST(affix_allocatorTest,
           ThatAFullAllocationReturnsAnEmptyBlockBecauseOfMissingSpaceForTheAffixes)
{
...
TYPED_TEST(affix_allocatorTest,
           ThatASmallAllocationsReturnsTheRequestedSizeAndThatTheMarkerAreSetCorrectly)
{
...
TYPED_TEST(affix_allocatorTest,
           ThatASmallAllocatedBlockIncreasingReallocatedIntoANewMemAreaKeepsTheOldMarker)
{
  this->mem = this->sut.allocate(8);
...
TYPED_TEST(affix_allocatorTest,
           ThatALargerAllocatedBlockDecreasingReallocatedKeepsThePositionAndTheOldMarker)
{
...
TYPED_TEST(affix_allocatorTest,
           ThatAnFilledBlockedExpandedIntoTheLimitsOfTheAllocatorBytesHasNowThatSizeAndHasNowMarker)
{
  auto firstSize = 8;
